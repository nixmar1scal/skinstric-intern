    ...
    <div className="main-content">
      <div className="content-columns">
        <div className="sidebar">
          ...
          <div
            className={`category-tab ${selectedCategory === "race" ? "active" : ""}`}
            onClick={() => setSelectedCategory("race")}
          >
            RACE
          </div>
          <div
            className={`category-tab ${selectedCategory === "age" ? "active" : ""}`}
            onClick={() => setSelectedCategory("age")}
          >
            AGE
          </div>
          <div
            className={`category-tab ${selectedCategory === "gender" ? "active" : ""}`}
        ...
        <div className="confidence-list">
          ...
          {sortedEntries.map(([label, value]) => (
            <div
              key={label}
              className={`confidence-item ${label === selectedValue ? "selected" : ""}`}
